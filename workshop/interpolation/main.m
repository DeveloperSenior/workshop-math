      function sol = main()
        ...
        m_parameters = [
                          (2*x^3)-x-1,(2*x^3)-x-1, 0.5, 1, 1, 500, 10^-5;
                          e^x - x^2,e^x - x^2, -1, 1, 0, 100, 10^-5;
                          sin(x) - x^2,sin(x) - x^2, 0.5, 1, -1, 100, 10^-5;
                          1/x - log(x),1/x - log(x), 0.5, 1, 2, 100, 10^-5;
                          x^4 - 3*x^2,x^4 - 3*x^2, 0.5, 1, 0, 200, 10^-5;
                          cos(x) - x,cos(x) - x, 0.5, 1, 0.5, 50, 10^-5;
                          e^(-x) - 1 / (x^2),e^(-x) - 1 / (x^2), 0.5, 1, 0.1, 100, 10^-5;
                          x^3 - 2*x^2 + x + 1,x^3 - 2*x^2 + x + 1, 0.5, 1, -2, 150, 10^-5;
                          x^1/2 - log(x),x^1/2 - log(x), 0.5, 1, 0, 100, 10^-5;
                          tan(x) - x,tan(x) - x, 0.5, 1, 0, 500, 10^-5
                       ];
         index = 1;
         while (index == 1)
